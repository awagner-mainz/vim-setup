" Vim syntax file
"
" Modified by Lars Noschinski <lars.noschinski@users.berlios.de> for mutt-ng
" Last Change:  06 March 2004
"
" Language:	Mutt setup files
" Maintainer:	Preben 'Peppe' Guldberg <peppe-vim@wielders.org>
" Contributor:	Gary Johnson <garyjohn@spk.agilent.com>

" This file covers mutt version 1.4.2.1i and mutt-ng rev. 149
...
" start mutt-ng specific keywords
syn keyword muttrcCommand	append-hook close-hook open-hook
" end mutt-ng specific keywords
...
" start mutt-ng specific keywords
syn keyword muttrcColorField	contained sidebar_new sidebar_flagged sidebar
" end mutt-ng specific keywords
